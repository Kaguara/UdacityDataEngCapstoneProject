...
Financial_institution_account_primary_education_or_less_age_15_plus  	VARCHAR(MAX),	
...
Used_the_internet_to_buy_something_online_in_the_past_year_male_age_15_plus											VARCHAR(MAX),
